  ...
  return (
    <div>
      <input
        ...
        className='placeholder-gray-600 w-full h-10 md:h-13 px-4 pl-6 text-gray-900 bg-white border-1 border-gray-600 rounded-3xl transition-colors duration-200 focus:outline-none '
      />

      <div className='mt-5 lg:mt-10 flex items-center h-15 md:h-20 lg:h-30 rounded-3xl'>
        <button
